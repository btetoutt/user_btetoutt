/* load the records. */
INSERT INTO t_user(user_id,user_name,birth_day,address,tel_bng,password,status,final_update) VALUES
...
INSERT INTO t_user(user_id,user_name,birth_day,address,tel_bng,password,status,final_update) VALUES
('0002','orange','1992/2/2','東京都中央区月島一丁目3-9','0387654321','$2a$10$oxSJl.keBwxmsMLkcT9lPeAIxfNTPNQxpeywMrF7A3kVszwUTqfTK','ACTV','2015/6/3 14:29');
INSERT INTO t_user(user_id,user_name,birth_day,address,tel_bng,password,status,final_update) VALUES
